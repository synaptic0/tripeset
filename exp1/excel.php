...
<p><strong>Visualizza dati</strong>: <a href="index.php">Combinati</a> | <a href="paradigma_fast.php">Paradigma FAST</a> | <a href="paradigma_slow.php">Paradigma SLOW</a></p>
...
<table border="1" cellspacing="2" cellpadding="2">
  <tbody>
    ...
    <tr>
      ...
      <td bgcolor="#D5FFDA"><?php echo round($Data[$s]['C_YT']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#D5FFDA"><?php echo round($Data[$s]['C_YO']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#D5FFDA"><?php echo round($Data[$s]['C_NT']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#D5FFDA"><?php echo round($Data[$s]['C_NO']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#FFEFEF"><?php echo round($Data[$s]['NC_YT']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#FFEFEF"><?php echo round($Data[$s]['NC_YO']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#FFEFEF"><?php echo round($Data[$s]['NC_NT']['AVG(RT)'], $PrecisioneDecimale); ?></td>
      <td bgcolor="#FFEFEF"><?php echo round($Data[$s]['NC_NO']['AVG(RT)'], $PrecisioneDecimale); ?></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
...
<h2>Subjects Acuracy for All Conditions</h2>
...
<table border="1" cellspacing="2" cellpadding="2">
  <tbody>
    <tr>
      ...
      <td bgcolor="#FF9798"><strong>Not Coherent * No Tool</strong></td>
      <td bgcolor="#FF9798"><strong>Not Coherent * No Object</strong></td>
      <td bgcolor="#FF0002"><strong style="color: #FFFFFF">Global Accuracy</strong></td>
    </tr>
    <?php for ($s = $PartiDalSoggettoNumero; $s <= $NumberOfSubjects; $s++) {
		$TotalAcc = 	1 - ($Data[$s]['C_YT']['EXTRA']['ERRORS'] +
						$Data[$s]['C_YO']['EXTRA']['ERRORS'] +
						$Data[$s]['C_NT']['EXTRA']['ERRORS'] +
						$Data[$s]['C_NO']['EXTRA']['ERRORS'] +
						$Data[$s]['NC_YT']['EXTRA']['ERRORS'] +
						$Data[$s]['NC_YO']['EXTRA']['ERRORS'] +
						$Data[$s]['NC_NT']['EXTRA']['ERRORS'] +
						$Data[$s]['NC_NO']['EXTRA']['ERRORS']) / 80;
	?>
    <tr>
      <td bgcolor="#ebebeb"><?php echo $s; ?></td>
      <td bgcolor="#D5FFDA"><?php echo 1 - $Data[$s]['C_YT']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#D5FFDA"><?php echo 1 - $Data[$s]['C_YO']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#D5FFDA"><?php echo 1 - $Data[$s]['C_NT']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#D5FFDA"><?php echo 1 - $Data[$s]['C_NO']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#FFEFEF"><?php echo 1 - $Data[$s]['NC_YT']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#FFEFEF"><?php echo 1 - $Data[$s]['NC_YO']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#FFEFEF"><?php echo 1 - $Data[$s]['NC_NT']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#FFEFEF"><?php echo 1 - $Data[$s]['NC_NO']['EXTRA']['ERRORS']/10; ?></td>
      <td bgcolor="#FFEFEF" style="color: #FF0004"><strong><?php echo $TotalAcc; ?></strong></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
